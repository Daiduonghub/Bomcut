...
function Library:CreateWindow(hubName)
    ...
    -- Khung chính UI (Đã phóng to rộng rãi, thoáng mắt hơn)
    ...
    -- Topbar (Tăng chiều cao lên 46px cho cân đối)
    ...
    -- Side Tab Container (Nới rộng bề ngang thanh tab bên trái lên 150px)
    ...
    function Window:CreateTab(tabName)
        ...
        -- BUTTON (Tăng chiều cao lên 40px, chữ rõ nét)
        ...
        function TabElements:CreateToggle(text, defaultState, callback)
            ...
            local function updateVisual()
                if state then
                    toggleBtn.BackgroundColor3 = Color3.fromRGB(0, 210, 255)
                else
